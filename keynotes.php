...
/**
 * functions.php : main file whixh wordpress includes automatically.
...
//  wp_head() -> includes WP scripts /css etc.

//  wp_footer() -> includes WP scrtips in footer.

// body_class() -> includes classes in body tags

// wp_body_open() -> allows to add async scripts at begining of the body tag
